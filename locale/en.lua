local Translations = {
    error = {
        ...
        duplicate_license           = '[OPCORE] - Duplicate Rockstar License Found',
        no_valid_license            = '[OPCORE] - No Valid Rockstar License Found',
        not_whitelisted             = '[OPCORE] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[OPCORE] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[OPCORE] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {
